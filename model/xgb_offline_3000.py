...
def run(train_fp, test_fp, pred_fp, key_fp):
	...
	params = {}
	with open("xgb_3000.params", 'r') as f:
		params = json.load(f)
...
if __name__ == "__main__":
	...
	train_fp = data_fp + "/train_libsvm_3000"
	test_fp = data_fp + "/test_libsvm_3000"
	pred_fp = data_fp + "/ans/ans_3000.csv"
	key_fp = data_fp + "/test_key_3000"
